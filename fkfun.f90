...
xmClalpha=-fA_unas_alpha*Ma*xmAalpha + fEO_asion_alpha*Meo*xmEOalpha + xmNaalpha  ! xmCl en alpha
xmClbeta=-fA_unas_beta*Ma*xmAbeta + fEO_asion_beta*Meo*xmEObeta + xmNabeta  ! xmCl en alpha

!if (xmClalpha.lt.0.0) xmClalpha = 1.e-20
!if (xmClbeta.lt.0.0) xmClbeta = 1.e-20
...
print*,x,norma,penality !if (Norma.lt.1E-5)then
ier = 0.0
return
end subroutine
